# REINFORCE is technically not an actor-critic method, as it lacks bootstrapping. It is included here for organizational purposes.
...
class REINFORCE:
  ...
  def train(self):
    ...
    for episode in range(self.total_episodes):
      ...
      moving_avg.append(
        (sum(rewards) + sum(returns[-min(window_len - 1, len(returns)) :]))
